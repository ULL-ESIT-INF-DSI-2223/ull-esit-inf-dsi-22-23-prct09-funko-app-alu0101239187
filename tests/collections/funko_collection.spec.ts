...
describe("FunkoCollection class tests", () => {
  ...
  it("FunkoCollection constructor", () => {
    ...
    expect(new FunkoCollection([new Funko(1, "Classic Sonic", "El mejor Funko de Sonic", FunkoTypes.POP, FunkoGenres.VIDEOGAMES, "Sonic The Hedgehog", 1, true, "", 50.99)])).to.be.instanceof(FunkoCollection);
  });

  it("show function", () => {
    const funko_collection: FunkoCollection = new FunkoCollection([new Funko(1, "Classic Sonic", "El mejor Funko de Sonic", FunkoTypes.POP, FunkoGenres.VIDEOGAMES, "Sonic The Hedgehog", 1, true, "", 50.99)]);

    expect(funko_collection.show(1)).to.be.equal("ID: 1\nNombre: Classic Sonic\nDescripción: El mejor Funko de Sonic\nTipo: Pop!\nGénero: Videojuegos\nFranquicia: Sonic The Hedgehog\nNúmero identificativo: 1\nExclusivo\nCaracterísticas especiales: \nValor de mercado: 50.99€\n");
  ...
  it("update function", () => {
    ...
    expect(funko_collection.show(1)).to.be.equal("ID: 1\nNombre: Classic Sonic\nDescripción: El mejor Funko de Sonic\nTipo: Pop!\nGénero: Videojuegos\nFranquicia: Sonic The Hedgehog\nNúmero identificativo: 1\nExclusivo\nCaracterísticas especiales: \nValor de mercado: 50.99€\n");
    expect(funko_collection.update(new Funko(1, "Shadow", "El mejor Funko de Shadow", FunkoTypes.POP, FunkoGenres.VIDEOGAMES, "Sonic The Hedgehog", 1, true, "", 50.99))).to.be.true;
    expect(funko_collection.show(1)).to.be.equal("ID: 1\nNombre: Shadow\nDescripción: El mejor Funko de Shadow\nTipo: Pop!\nGénero: Videojuegos\nFranquicia: Sonic The Hedgehog\nNúmero identificativo: 1\nExclusivo\nCaracterísticas especiales: \nValor de mercado: 50.99€\n");
    expect(funko_collection.update(new Funko(2, "Shadow", "El mejor Funko de Shadow", FunkoTypes.POP, FunkoGenres.VIDEOGAMES, "Sonic The Hedgehog", 1, true, "", 50.99))).to.be.false;
  });
  ...
  it("list function", () => {
    ...
    funko_collection.add(new Funko(1, "Classic Sonic", "El mejor Funko de Sonic", FunkoTypes.POP, FunkoGenres.VIDEOGAMES, "Sonic The Hedgehog", 1, true, "", 50.99))
    expect(funko_collection.list()).to.be.equal("--------------------------------\nID: 1\nNombre: Classic Sonic\nDescripción: El mejor Funko de Sonic\nTipo: Pop!\nGénero: Videojuegos\nFranquicia: Sonic The Hedgehog\nNúmero identificativo: 1\nExclusivo\nCaracterísticas especiales: \nValor de mercado: 50.99€\n--------------------------------\n");
  });
});
